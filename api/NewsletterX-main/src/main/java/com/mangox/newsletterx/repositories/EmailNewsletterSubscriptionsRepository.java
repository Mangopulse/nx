...
public interface EmailNewsletterSubscriptionsRepository extends JpaRepository<EmailNewsletterSubscriptions,Long> {
    ...
    List<EmailNewsletterSubscriptions> getSubscriptionsByDomainWithPagination(String appDomain, int limit, int offset);
